<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Rentmodule.aspx.cs" Inherits="Rentmodule" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row no-gutters">
        <div class="col">
            ...
            <asp:TextBox ID="txtrplace" CssClass="form-control" placeholder="Enter locality or city" runat="server"></asp:TextBox>

        </div>
        <div class="col">

              <asp:DropDownList ID="ddlrprice" ClientIDMode="Static" runat="server" CssClass="form-control ddly">
        <asp:ListItem>Select Budget</asp:ListItem>
        <asp:ListItem>10 thousand-20 thousand</asp:ListItem>
        <asp:ListItem>20 thousand-30 thousand</asp:ListItem>
        <asp:ListItem>30 thousand-40 thousand</asp:ListItem>
        <asp:ListItem>40 thousand-50 thousand</asp:ListItem>
        <asp:ListItem>50 thousand-60 thousand</asp:ListItem>
        <asp:ListItem>60 thousand-70 thousand</asp:ListItem>
                   <asp:ListItem>70 thousand-80 thousand</asp:ListItem>
                   <asp:ListItem>80 thousand-90 thousand</asp:ListItem>
                   <asp:ListItem>90 thousand-1 lakh</asp:ListItem>
    </asp:DropDownList>


        </div>
        <div class="col">
            <button id="rentsearch" class="form-control w3-hover-red" style="width:150px" runat="server" onserverclick="search"><i class="fa fa-search" aria-hidden="true"></i></button>
            ...
            <ItemTemplate>
               ...
               <tr>
                   <td>
                        ...
                        <asp:Image ID="img1" ClientIDMode="Static" runat="server"  width="400" Height="300" CssClass="img-thumbnail"  ImageUrl='<%#Eval("propertyFirstImg") %>'/>
                   </td>
                   <td>
    ...
    <asp:Label ID="lblDefaultMessage" runat="server" Text="Sorry, no Property is there to show." Visible="false">
    </asp:Label>
</FooterTemplate> 
    ...
    <script>
        ...
        document.getElementById("ddlrprice").options[0].disabled = true;
